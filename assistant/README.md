...
Visuelle Designauswahl (17.09.2026): „Was passt zu mir?“ ist eine schwarze Hauptaktion. Produktarten werden konsistent mit Tücher vor Mäppchen sortiert, auch beim Ändern der Kategorie. Kategoriebuttons zeigen ein aktuelles Beispielbild. Buttons zur konkreten Design-/Match-Auswahl zeigen das jeweilige Shopify-Produktbild und den Namen. Bilder sind dekorativ (leerer Alternativtext); zugängliche Buttonnamen und gespeicherte Dialogschritte bleiben unverändert. Fehlgeschlagene Bilder entfallen zugunsten des Textbuttons.
